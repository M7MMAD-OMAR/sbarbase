...
This is the selected implementation reference, not a user-approved production design.
Direction: Supabase Studio neutral dark surfaces and green actions, using its
[color usage guidance](https://supabase.com/design-system/docs/color-usage).
...
Tokens: background #171717, sidebar #1c1c1c, surface #202020, border #303030,
