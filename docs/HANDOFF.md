...
[Atomic HBA replacement](ATOMIC-HBA-REPLACEMENT.md) now validates complete content before replacing connection rules. Sixteen real interruption checks cover producer EOF and helper death around rename. Stale complete writers and activation recovery remain unresolved.
