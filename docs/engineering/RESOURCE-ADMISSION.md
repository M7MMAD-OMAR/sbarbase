...
Admission now also checks [owned-container PSI pressure](PRESSURE-ADMISSION.md); a passing instantaneous snapshot is still not sustained resource isolation.
