...
|---|---|---|---|
| v0.9.1 | PostgREST v14.15 to v14.16 | "check now" and "install" through the management API as the operator | confirmed, trigger `console` |
