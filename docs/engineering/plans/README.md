...
| 2026-09-21 | [CONTAINER-GENERATION-MIGRATION](../CONTAINER-GENERATION-MIGRATION.md) | journaled replacement of a managed database container | built and crash-tested; the attended run on the retained database remains |
