...
تقع إعدادات التحديث في لوحة الإدارة وطلباتها وسجل الترقية في `.lab/upgrades/`، خاصة بحساب الخدمة (المجلد 0700، والملفات 0600، ويُستبدل كل ملف دفعة واحدة). لا تكتب لوحة الإدارة إلا `settings.json` و`request.json`، ويكتب المشرف الباقي ([الترقيات](../guides/upgrades.ar.md)).
