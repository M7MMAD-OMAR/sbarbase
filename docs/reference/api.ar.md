...
- **الطرق:** GET وHEAD وPOST وPUT وPATCH وDELETE.
...
حدود القبول تخص كل عملية بوابة وحدها، ولا طابور لها. لا تُوجَّه بعدُ طلبات Realtime وEdge Functions وCORS في المتصفح وتدفقات مزودي OAuth.
