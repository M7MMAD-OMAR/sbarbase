...
|---|---|---|
| قناة الإصدارات وأصنافها، وملفات الطلب والإعدادات والحكم، وقرار التحديث التلقائي ومحاولاته، واللقطة واستعادتها، والحارس، والتصريف، والاعتماد المشروط بالفحوص، ومنطق فحص الترقية في CI نفسه (ملف الترقية يضم أيضًا اختبارات الترقية الأقدم) | `lab/test_release_channel.py`، `lab/test_updates.py`، `lab/test_upgrade.py`، `lab/test_upgrade_health.py`، `lab/test_upgrade_guard.py`، `lab/test_upgrade_drain.py`، `lab/test_upgrade_check.py` | 213 اختبار Python، نجحت على محطة العمل في 2026-09-26؛ ومجموعة Python كاملة 1040، نجحت |
