...
- Studio من Supabase لكل بيئة (موصوف في [مواصفة التكامل](../engineering/STUDIO-INTEGRATION.md)، ولا يُقدَّم بعد).
- Realtime وEdge Functions ومجمّع الاتصالات وcron.
- النسخ الاحتياطي المجدول أو خارج الخادم، والاستعادة إلى نقطة زمنية، وأمر تصدير عام لكل بيئة.
...
- اعتماد أي إصدار من الأصل عبر سياسة التحديث؛ والترقيات التلقائية.
- النقل الكامل للمشروع بين العملاء، والدعوات، وMFA، وتحديد معدل محاولات الدخول.
- مكان تشغيل على عدة خوادم والتنسيق بينها.
- الرفع الكبير أو القابل للاستئناف، وCORS للمتصفح، ومزوّدو OAuth عبر البوابة.
