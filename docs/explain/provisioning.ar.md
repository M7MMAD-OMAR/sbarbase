...
![خمس خطوات: مهمة جديدة، ويستلمها عامل واحد، ويكتب إيصال أثر على القرص، وينفّذ الأثر المسيّج، ويسجّل النتيجة ويستهلك الإيصال؛ وبعد الانهيار يُغلق الإيصال المكتمل، ويعاد إلى الطابور ما ثبت أنه توقف قبل أي تغيير، وتتوقف النتيجة المجهولة للمشغّل](../diagrams/provisioning.ar.svg)

*سجّل أولًا، ثم نفّذ، ثم أغلق. النتيجة المجهولة لا تُنفَّذ مرتين بالتخمين.*

التبادل نفسه في مخطط تسلسلي:
