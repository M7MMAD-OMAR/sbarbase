...
![على اليسار ثلاث حزم Supabase كاملة تكرر كل واحدة منها كل المكوّنات؛ وعلى اليمين صباربيز ببوابة واحدة، وAuth وREST لكل بيئة، ومحرك PostgreSQL واحد فيه قاعدة بيانات لكل بيئة، وStorage واحد مشترك؛ والأجزاء المشتركة حدود فشل مشتركة](../diagrams/full-stack-vs-shared.ar.svg)

*محرك واحد وStorage واحد بدل حزمة كاملة لكل تطبيق، فيتسع الخادم نفسه لمشاريع أكثر.*
