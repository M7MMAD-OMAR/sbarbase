...
![مقارنة بحزمة كاملة لكل مشروع، يتشارك صباربيز بوابة واحدة ومحرك PostgreSQL واحدًا وعملية Storage واحدة، ويشغّل Auth وREST لكل بيئة](../diagrams/full-stack-vs-shared.svg)

![ينتقل الطلب من التطبيق إلى البوابة، فتتحقق من المفتاح للبيئة المذكورة في المسار وترفض فورًا بـ429 أو 503 بدل وضعه في طابور، ثم يصل إلى Auth أو REST في تلك البيئة وحساب دخولها الخاص إلى قاعدتها؛ وتذهب الملفات إلى Storage المشترك مع ترويسة المستأجر](../diagrams/request-path.svg)
...
- الرفع يُخزَّن مؤقتًا حتى 1 MiB؛ والرفع الكبير والقابل للاستئناف وCORS في المتصفح ومزودو OAuth لم تكتمل.
- لم تدخل بعدُ في البنية العاملة: Realtime وEdge Functions ومجمّع الاتصالات (pooler) وcron وStudio لكل بيئة.
