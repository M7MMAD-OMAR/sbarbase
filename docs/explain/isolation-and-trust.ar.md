...
![دفعة كبيرة على البيئة أ تملأ أماكنها الثمانية في البوابة فيتلقى الطلب التاسع 429 فورًا، بينما للبيئة ب أماكن فارغة فتُخدم؛ وخلف البوابة لكل بيئة حاوياتها بحدود للمعالج والذاكرة والقرص، وحدود اتصالاتها في المحرك المشترك](../diagrams/load-isolation.ar.svg)

*يُرفض الضغط الزائد على بيئة واحدة عند حدودها، وتبقى البيئات الأخرى تُخدم. هذه الحدود غير معايرة تحت حمل مستمر.*
