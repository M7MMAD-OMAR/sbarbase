...
![خمس خطوات: إيقاف الكتابة، ثم تصدير مشفّر، ثم استعادة إلى محرك مستقل، ثم تحقق، ثم تحويل المسار؛ إذا فشل التحقق تبقى بيانات المصدر سليمة ومسيّجة حتى يعيد المشغّل فتحها، والتصدير يوقف Storage المشترك لكل البيئات على المحرك](../diagrams/restore-flow.ar.svg)

*تحقق قبل التحويل. التصدير ما زال يوقف Storage المشترك لكل البيئات على المحرك.*
