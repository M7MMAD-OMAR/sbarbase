...
![خريطة الوثائق: الشروح لفهم سبب عمله بهذه الطريقة، والأدلة العملية لتنفيذ مهمة، والمرجع للحقائق التي تبحث عنها، والقرارات لفهم سبب هذا التصميم، والدفتر الهندسي لملاحظات مؤرخة حين تريد التعمق](diagrams/docs-map.svg)
