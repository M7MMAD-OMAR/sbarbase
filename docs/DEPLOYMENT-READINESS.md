...
| Full source and target lifecycle rehearsal | **passed on this host** | `docs/evidence/deployment-rehearsal.json`, 10 of 10 checks, 2026-09-20 16:08 to 16:09 (63 s): preflight, built page intact, supervisor start (needed 2 attempts while the host was under pressure), console serving, management identity realm 200, all 8 environment routes 200, 14 combined gateway checks, clean shutdown, no owned container left running. Recorded host: Docker 29.7.2, Bun 1.3.14, Python 3.14.7, 8614 MiB available |
