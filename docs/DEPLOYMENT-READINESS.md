...
| Deployment rehearsal in one command | implemented, records refusal honestly | `lab/deployment_rehearsal.py`; the committed run passed 11 of 11 on 2026-09-20 16:38 (`docs/evidence/deployment-rehearsal.json`). A run started while the host is short of memory instead records `Host headroom insufficient` and starts nothing, as measured on this host at 100 MiB available |
