...
import {Activity as ActivityIcon,Folder,LogOut,Plus} from 'lucide-react';
import {api,auth,useData,type Api,type Organization,type Project,type Environment} from './api';
import {Brand} from './Brand';
import {Login} from './Login';import {Projects} from './Projects';import {Environments} from './Environments';import {Connection} from './Connection';import {Activity} from './Activity';import {AcceptInvitation,inviteToken,useJoinWithSession} from './Invite';
...
function Console({session}:{session:Session}){
 ...
 const joinError=useJoinWithSession(session,()=>organizations.refresh());
 const [creating,setCreating]=useState(false);
 const [selected,setSelected]=useState(''),[project,setProject]=useState<Project>(),[environment,setEnvironment]=useState<Environment>(),[view,setView]=useState<'projects'|'activity'>('projects');
