...
import {UpdateBanners,Updates,useUpdates} from './Updates';
...
function Console({session}:{session:Session}){
 ...
 const updates=useUpdates(updatesClient,operator);
