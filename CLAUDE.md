...
log is `docs/engineering/checkpoints.md`. Diagrams are SVG files in
`docs/diagrams/`, generated by `docs/diagrams/build.py` in English and Arabic
(`X.svg`, `X.ar.svg`). `docs/evidence/`, `docs/design/` and `docs/diagrams/`
