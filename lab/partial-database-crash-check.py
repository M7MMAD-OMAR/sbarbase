...
console.log('blocked');}finally{c.close();}"""
    ...
    if hba_apply:evidence['scope']='Pinned Supabase PostgreSQL single-attempt HBA publication, parser validation and durable reload-signal acknowledgment witness. Exact HBA-slot success settlement covers live originating ownership and host SIGKILL after durable witness publication. Not activation confirmation, job settlement or supervisor integration.'
