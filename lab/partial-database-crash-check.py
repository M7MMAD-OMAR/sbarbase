...
console.log('blocked');}finally{c.close();}"""
    ...
    if hba:evidence['scope']='Pinned upstream HBA replacement: producer EOF, checksum rejection, helper SIGKILL before/after rename, immutable prepared revisions, competing writers and lock-holder death. Not full operation revocation, power-loss or activation recovery.'
